...
def run_acc_demo(data):
    ...
    real_acc = acc_gen(fs, data, acc_err, vib_def)
    return real_acc
    # print(real_acc)



def run_gyro_demo(ref_w):
    fs = 100  # Hz
    # num_samples = 10
    ...
    env = '[0.105 0.087 0.069]d-0.5Hz-sinusoidal'
    vib_def = vib_from_env(env, fs)

    real_gyro = gyro_gen(fs, ref_w, gyro_err, vib_def)
